...
MASK_PROCESSING_DEFAULTS = {
    ...
    "cleanup_dilate_iterations": 2,
    "cleanup_dilate_kernel_size": 7,
...
INPAINTER_DEFAULTS = {
    ...
    "lama.device": "auto",
    "lama.modulo": 8,
    "lama.dilate_mask_iterations": 3,
    "lama.mask_kernel_size": 7,
...
DETECTOR_DEFAULTS = {
    ...
    "paddle_ocr.confidence_threshold": 0.35,
    "paddle_ocr.min_area": 25,
    "paddle_ocr.dilate_iterations": 2,
    "easy_ocr.confidence_threshold": 0.35,
